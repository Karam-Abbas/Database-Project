        ...
        public ActionResult Create(Product product)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (IsInserted)
                    {
                        TempData["SuccessMessage"] = "Product added succesfully...!";
                    }
                    else
                    {
                        TempData["ErrorMessage"] = "Product is already Available/Unable to save the product";
                    }
        ...
        public ActionResult UpdateProduct(Product product)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (IsUpdated)
                    {
                        TempData["SuccessMessage"] = "Product updated added succesfully...!";
                    }
                    else
                    {
                        TempData["ErrorMessage"] = "Unable to Edit";
                    }
                }
                return RedirectToAction("Index");
            }
